function axonometry() {
  ...
  //  DIMETRICA ==> GLI ANGOLI X-Y E Z-Y SONO UGUALI TRA LORO MENTRE E' DIVERSO SOLO QUELLO TRA X-Z

  B1 = makeProjMatr(50, 16/9, 1, 101);
